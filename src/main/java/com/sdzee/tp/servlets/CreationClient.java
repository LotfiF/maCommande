...
@WebServlet( urlPatterns = { "/client/creationClient" }, initParams = @WebInitParam( name = "chemin", value = "/fichiers/images/" ) )
...
public class CreationClient extends HttpServlet {
    ...
    public static final String VUE_SUCCES = "/client/afficherClient.jsp";
    public static final String VUE_FORM   = "/client/creationClient.jsp";
