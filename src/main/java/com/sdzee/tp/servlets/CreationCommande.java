...
@WebServlet( urlPatterns = { "/commande/creationCommande" }, initParams = @WebInitParam( name = "chemin", value = "/fichiers/images/" ) )
...
public class CreationCommande extends HttpServlet {
    ...
    public static final String VUE_SUCCES        = "/commande/afficherCommande.jsp";
    public static final String VUE_FORM          = "/commande/creationCommande.jsp";
